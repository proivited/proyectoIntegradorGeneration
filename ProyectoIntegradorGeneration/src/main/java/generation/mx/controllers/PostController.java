...
public class PostController {
	...
	@GetMapping("/query")
	public ArrayList<PostModel> getPostsByTitle(@RequestParam(value = "title",
	defaultValue = "") String title){
		return postService.getPostsByTitle(title);
	}
	
	@GetMapping("/q")
	public ArrayList<PostModel> getPostsByContainingOrderByIdDesc(@RequestParam(value = "title",
	defaultValue = "") String title){
